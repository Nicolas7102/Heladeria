...
public abstract class Helado {
    ...
    // Agregar excepciones. Lista de lugares donde las pongo: Main? ... ...
    // Agregar ofertas / combos
    // Agregar algunos helados mas
    //Intentar buscar una excusa para usar interfaces.
    // Como hago si una persona compra mas de un helado? --> Crear clase Orden/Compra/Factura con un arraylist de tipo helado, descuento en efectivo? Descuento si tiene dos kilos o algo por el estilo
    // Hacer el gui como clase instanciable
    // Crear cupones de descuento
    // Deberia poner el metodo que esta en el main en las clases, o no?
